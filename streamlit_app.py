        ...
        if st.session_state.get('editing_row') is not None:
            ...
            with st.form("edit_form"):
                ...
                with col3:
                    ...
                    stand_options = ['Select', 'DC#1', 'DC#2']
                ...
                with col1:
                    ...
                    position_options = ['Select', 'TOP', 'BOT']
                ...
                with col2:
                    edit_crown = st.text_input("👑 Crown", value="STRAIGHT", disabled=True)
                with col3:
                    current_pre_dia = edit_data.get('pre dia', '')
                    if isinstance(current_pre_dia, (int, float)):
                        current_pre_dia = str(current_pre_dia)
                    edit_pre_dia = st.text_input("📏 Pre Dia (mm)", value=str(current_pre_dia))
                ...
                if update_submitted:
                    ...
                    # Validate pre_dia
                    try:
                        edit_pre_dia_val = float(edit_pre_dia) if edit_pre_dia.strip() != "" else ""
                    except ValueError:
                        errors.append("❌ Pre Dia must be a valid number")
                        edit_pre_dia_val = ""
                    ...
                    if errors:
                        ...
                        updated_row = [str(edit_date), edit_roll_no, edit_stand, edit_position, "STRAIGHT", edit_pre_dia_val] + [filtered_edit_diameters.get(d, "") for d in DISTANCES]
